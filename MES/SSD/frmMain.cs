...
namespace mes_
{
    public partial class frmMain : Form
    {
        ...
        private void treeview_vpk_1()
        {
            ...
            warehouseOut.Nodes.Add(menuname("MB14", "VPV 이동"));
        ...
        private void mdiShow(TreeNode SelectedNode)
        {
            ...
            switch (nodename)
            {
                ...
                case "PA06":
                    ...
                    {
                        new frm현황판_VPV(_connection).Show();
                        break;
                    }
                ...
                case "PP14": new frm_재경팀결산_VP().Show(); break;
                ...
                case "A080": childForm = new frmVPK1_LeakTest(_connection); break;
                ...
                */
                ...
                if (dbsite == "VPK-02")
                {
                    switch (tvMain.SelectedNode.FullPath)
                    {
                        ...
                        case "생산관리\\조회\\[NEW] 재경팀결산": new frm_재경팀결산_VP().Show(); break;
                        ...
                        // ---------------------------------------------------------------------------------------------------------------------
                        case "EHDD 창고\\제품 입고": childForm = new FrmVpkIncomming(_connection); break;
                        case "EHDD 창고\\출하 등록": childForm = new FrmVpkShipping(_connection); break;
                        case "EHDD 창고\\재고/출하 현황": childForm = new FrmVpkStore(_connection); break;
                        case "EHDD 창고\\시리얼번호 조회": childForm = new frmVPKSearch(_connection); break;
                        case "EHDD 창고\\재작업": childForm = new frmSGReprint(_connection); break;

                        case "EHDD 창고\\Carton 확인": childForm = new frmVPK_CartonCheck(_connection); break;
                        // ---------------------------------------------------------------------------------------------------------------------
                        ...
                        // ---------------------------------------------------------------------------------------------------------------------
                        case "설비/치공구\\설비/치공구 등록": childForm = new frmEquipmentRecord_vpk2(_connection); break;
                        case "설비/치공구\\설비/치공구 관리": childForm = new frmEquipmentList_vpk2(_connection); break;
                        // ---------------------------------------------------------------------------------------------------------------------
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            tableLayoutPanel1.BackColor
                ...
                = (cbDBsite.Text.Contains("VPV")) ? Color.Olive : Color.SlateGray;
            ...
            //#if !DEBUG
            if (dbsite == "VPK-01" && user_ID != "PHS" && user_ID != "AUTO" && user_ID != "AUTOCASE")
            ...
            if (dbsite == "VPK-01")
            {
                ...
                _msconnection.Open();
                SqlCommand mssql = new SqlCommand("SELECT COUNT(*) FROM VP_ERP.dbo.p_bom_detail ", _msconnection);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text != string.Empty)
                sendEmail($@"[CALL MESSAGE] MES+ Build Ver: {version}, {windowName}, {textBox1.Text.ToUpper()}, {frmMain.userName}", "phs@valueplus.co.kr");
        ...
        {
            if (frmMain.dbsite.Contains("VPK-02"))
            {
