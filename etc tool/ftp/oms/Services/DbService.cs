...
namespace tcp_socket.Services
{
    public class DbService : IDisposable
    {
        ...
        // connectionStringKey is expected to be used by existing Helper.InitConnection or
        // direct connection string can be passed. For simplicity we'll accept a MySQL connection string.
